		...
		<c:choose>
			...
			<c:when test="${grade=='1' }">
				<ul class="sidebar-nav">
					<li class="sidebar-brand"><a href="myPage">관리자페이지</a>
						<hr style="width: 60%;"></li>
					<li><a href="myPage">나의 프로필</a></li>
					<li><a href="resList">회원 관리</a></li>
					<li><a href="#">휴면회원 관리</a></li>
					<li><a href="#">추천검색어 관리</a></li>
					<li><a href="#">숙소등록 관리</a></li>
					<li><a href="#">식당등록 관리</a></li>
					<li><a href="#">실시간채팅 관리</a></li>
				</ul>
			</c:when>
			<c:when test="${grade=='2' }">
				<ul class="sidebar-nav">
